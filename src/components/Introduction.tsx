    ...
    return (
        ...
        <div className="max-w-7xl mx-auto my-12">
            <div className='flex-cols gap-y-10 gap-x-8 py-16 md:grid'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-4 p-6 md:p-0'>
                {teamMembers.map((member, index) => (
                        <div key={index} className="bg-maingrey  rounded-lg hover:rounded-4xl transition-all hover:bg-mainblue transition-colors hover:text-white flex md:flex-col flex-row gap-4 md:gap-0 md:justify-center items-center md:min-h-60 p-10 md:text-center">
