        ...
        <section className='bg-gradient-to-t from-mainaccent  to-mainprimary mb-6'>
            ...
            <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-4">
                ...
                <div className='flex flex-col justify-center items-center text-white'>
                    ...
                    <p className='p-6 text-center md:text-left md:p-0'>We help you accept global debit and credit card payments for all card brands and local payment methods.</p>
